...
class NhaTroUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'required|integer|exists:nha_tro,id',
    ...
    {
        return [
            'id.required' => 'Mã nhà trọ không được để trống.',
            'id.integer' => 'Mã nhà trọ phải là số nguyên.',
            'id.exists' => 'Nhà trọ không tồn tại.',
